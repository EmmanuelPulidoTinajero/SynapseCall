import { createMeeting, getMeetings } from "../app/meetings/meetings.controller";
import Meeting from "../app/meetings/meetings.model";
...
describe("Meetings", () => {
	...
	const meetingModel = Meeting as any;
